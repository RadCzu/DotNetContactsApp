...
namespace DotNetContactsApp.Areas.Identity.Pages.Account
{
    public class LoginModel : PageModel
    {
        ...
        public LoginModel(SignInManager<ContactsAppUser> signInManager, ILogger<LoginModel> logger)
        {
        ...
        public async Task<IActionResult> OnPostAsync(string returnUrl = null)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                //sadly this does not work properly, and only emails can enter still. I cant find the reason why.
                string emailOrUsername = Input.VerifyInputType();
